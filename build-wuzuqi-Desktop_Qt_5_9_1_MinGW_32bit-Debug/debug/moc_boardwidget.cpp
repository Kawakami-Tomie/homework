...
#include "../../wuzuqiii/boardwidget.h"
...
QT_MOC_LITERAL(4, 29, 14), // "turnNextPlayer"
QT_MOC_LITERAL(5, 44, 6), // "player"
QT_MOC_LITERAL(6, 51, 7), // "newGame"
QT_MOC_LITERAL(7, 59, 9), // "downPiece"
QT_MOC_LITERAL(8, 69, 1), // "x"
QT_MOC_LITERAL(9, 71, 1), // "y"
QT_MOC_LITERAL(10, 73, 4), // "undo"
QT_MOC_LITERAL(11, 78, 5) // "steps"

    },
    "BoardWidget\0gameOver\0\0winner\0"
    "turnNextPlayer\0player\0newGame\0downPiece\0"
    "x\0y\0undo\0steps"
};
...
void BoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->turnNextPlayer((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->newGame(); break;
        case 3: _t->downPiece((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 4: _t->undo((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (BoardWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoardWidget::turnNextPlayer)) {
                *result = 1;
                return;
            }
        }
