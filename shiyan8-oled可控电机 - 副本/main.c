...
//		}
//		
//		if(flag==1&&zhengfan==1)zhengrun(SPEED);
//		if(flag==1&&zhengfan==0)fanrun(SPEED);		
//		
//	
//}
//}
...
//			{
//				stepmove=!stepmove;
//				LCD12864_Write16CnCHAR(0,0,"院空空空空空");
//			}				
//		
...
//			{
//				dir=!dir;		
//	LCD12864_Write16CnCHAR(0,0,"院院院院空空");				
//			}	
//	
//			else if (key==KEY2_PRESS)//按下按键二令步进电机加速
//			{
//				if(speed>SPEEDMAX)
//					speed-=1;
//				LCD12864_Write16CnCHAR(0,0,"院院空空空空");
//			}
//			else if (key==KEY3_PRESS)  				
//			{
//				if(speed<SPEEDMIN) //按下按键三令步进电机减速
//					speed+=1;	
//				LCD12864_Write16CnCHAR(0,0,"院院院空空空");
