...
public:
	...
	{
		m_score = (m_dailyscore + m_endscore) / 2;
	}
	int m_id;
	string m_name;
			...
			else if (teacherchoice == 2) //进入学生信息
			{
				while (1)
				{
					...
					case 1: //录入学生成绩
						...
						cout << "请输入学生平时成绩："; cin >> student.m_dailyscore;
					...
					case 2: //修改学生成绩
						...
						for (int i = 0; i < arr_student.size(); i++)
						{
							...
							{
								cout << "请输入学生平时成绩修改为："; cin >> arr_student[i].m_dailyscore;
								cout << "请输入学生期末成绩修改为："; cin >> arr_student[i].m_endscore;
			...
			else if (teacherchoice == 3) //信息显示
			{
				...
				else if (showchoice == 3)
				{
					...
					else
					{
						...
						cout << "平时成绩" << maxscore(arr_student).m_dailyscore << "\t" << minscore(arr_student).m_dailyscore << "\t" << avescore(arr_student).m_dailyscore << "\t"; dailyscorenum(arr_student);
